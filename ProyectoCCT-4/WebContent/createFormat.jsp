...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  <div class="form-group">
    <label class="col-md-3 control-label">Nombre Formato</label>
    <div class="col-md-3">
    ...
    <div class="form-group">
    <label class="col-md-3 control-label">ID Formato</label>
    <div class="col-md-3">
      <input type="text" class="form-control" id="idFormato" name="idFormato"
             placeholder="Nombre Formato">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label class="col-md-3 control-label">Versi&oacute;n</label>
    <div class="col-lg-3">
